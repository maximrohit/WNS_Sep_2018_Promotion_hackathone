...
result_matrix
View(result_matrix)
#[3,] 0.9282326   0.2164286   0.9944821
#model_4.6 is the one that is using least varaible and comparable Sensitivity & Specificity
summary(model_4.6)
# Coefficients:
#                               Estimate Std.    Error  z value Pr(>|z|)    
#   (Intercept)                   -16.09209    0.27829 -57.826  < 2e-16 ***
#   previous_year_rating            0.26680    0.02065  12.923  < 2e-16 ***
#   `KPIs_met >80%`                 1.74852    0.05017  34.852  < 2e-16 ***
#   `awards_won?`                   1.46322    0.09129  16.028  < 2e-16 ***
#   avg_training_score              0.81404    0.01738  46.842  < 2e-16 ***
#   departmentFinance               5.39355    0.16712  32.274  < 2e-16 ***
#   departmentHR                    7.70557    0.21967  35.078  < 2e-16 ***
#   departmentLegal                 5.09883    0.23031  22.139  < 2e-16 ***
#   departmentOperations            5.50416    0.13988  39.349  < 2e-16 ***
#   departmentProcurement           3.26249    0.10726  30.416  < 2e-16 ***
#   `departmentSales & Marketing`   8.07340    0.19059  42.359  < 2e-16 ***
#   departmentTechnology            1.93224    0.08669  22.289  < 2e-16 ***
#   regionregion_22                 0.43627    0.05983   7.292 3.05e-13 ***
#   regionregion_4                  0.56029    0.10329   5.424 5.81e-08 ***

#so we have 6 deciding variables
# previous_year_rating
# `KPIs_met >80%`   2nd most prominent 
# `awards_won?`     3rd most prominent 
# avg_training_score
# department (most of them) : departments are teh mazor contributoes in deciding 
# region (22 & 4 prominently)
...
#   0.087 0.7853667   0.7714286   0.7866640 0.7789718
...
test_pred_churn <- factor(ifelse(test_pred >= 0.087, "Yes", "No"))
test_actual_churn <- factor(ifelse(test$is_promoted, "Yes", "No"))
test_conf <- caret::confusionMatrix(data=test_pred_churn, reference=test_actual_churn, positive = "Yes")
test_conf
# Accuracy : 0.7854    
...
test_pred_churn <- ifelse(test_pred >= 0.08, 1, 0)
